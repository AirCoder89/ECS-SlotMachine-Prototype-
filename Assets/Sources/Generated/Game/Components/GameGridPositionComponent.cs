...
public partial class GameEntity {
    ...
    public void AddGridPosition(Dimension newValue) {
        var index = GameComponentsLookup.GridPosition;
        var component = CreateComponent<GridPositionComponent>(index);
        component.value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceGridPosition(Dimension newValue) {
        var index = GameComponentsLookup.GridPosition;
        var component = CreateComponent<GridPositionComponent>(index);
        component.value = newValue;
