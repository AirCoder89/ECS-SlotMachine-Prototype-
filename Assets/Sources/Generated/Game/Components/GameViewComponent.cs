...
public partial class GameEntity {
    ...
    public void AddView(UnityEngine.UI.Image newBackground, UnityEngine.UI.Image newIcon) {
    ...
    public void ReplaceView(UnityEngine.UI.Image newBackground, UnityEngine.UI.Image newIcon) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<ViewComponent>(index);
        component.background = newBackground;
        component.icon = newIcon;
