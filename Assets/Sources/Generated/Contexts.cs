...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, Dimension>(
            GridPosition,
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithGridPosition(this GameContext context, Dimension value) {
        return ((Entitas.EntityIndex<GameEntity, Dimension>)context.GetEntityIndex(Contexts.GridPosition)).GetEntities(value);
    }

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithItemId(this GameContext context, string value) {
        return ((Entitas.EntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.ItemId)).GetEntities(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
